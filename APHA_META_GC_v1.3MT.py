...
if proceed == "Y" or proceed == "y":
    ...
    def run_megahit_kraken(f):
        ...
        os.system(
            f'kraken2 --db /home/guidocordoni/fsx/ranch-44/Bactipipes/BactiPipes_SCE3/Programs/Kraken2/standard_db_2021-05-17 --threads 16 --memory-mapping --use-names --report {KRAKEN_report_path2} --output {KRAKEN_report_path} "{assembly_output_dir}/final.contigs.fa"'
        )
